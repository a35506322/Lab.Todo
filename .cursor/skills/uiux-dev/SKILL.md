...
3. 使用 PrimeVue 的元件庫 + Tailwind CSS 進行 UIUX 設計
4. 使用 mock 資料進行綁定
5. 以簡單的 UIUX 設計為主，不要過度複雜
6. 先規劃文字線稿圖，再進行 UIUX 設計

## UIUX 開發工作流程步驟

**步驟一：理解 API 規格**

如有規格請查查閱 src/TodoAPI/Module 相關的 API 規格
...
**步驟三：將 API 規格跟文字線稿圖轉換為 UIUX 設計**

使用 PrimeVue 的元件庫進行 UI 設計，並使用假資料進行綁定

專案現行使用的 Dashboard Template
